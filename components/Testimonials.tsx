...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-white relative overflow-hidden">
       ...
       <div className="absolute top-0 left-0 w-64 h-64 bg-sage-50 rounded-full mix-blend-multiply filter blur-3xl opacity-50 -translate-x-1/2 -translate-y-1/2"></div>
       <div className="absolute bottom-0 right-0 w-96 h-96 bg-terracotta-500/5 rounded-full mix-blend-multiply filter blur-3xl opacity-50 translate-x-1/3 translate-y-1/3"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <span className="text-terracotta-600 font-semibold tracking-wide uppercase text-sm">Success Stories</span>
