...
export const Hero: React.FC<HeroProps> = ({ onContactClick }) => {
  ...
  return (
    <div className="relative overflow-hidden bg-stone-50 pt-32 pb-16 lg:pt-48 lg:pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-sage-100 text-sage-800 text-sm font-medium mb-6">
              <span className="flex h-2 w-2 rounded-full bg-sage-600 mr-2"></span>
              London Based & Online Coaching
            </div>
            <h1 className="text-4xl tracking-tight font-extrabold text-stone-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl font-serif">
              <span className="block xl:inline">Not just a workout plan.</span>{' '}
              <span className="block text-sage-700 mt-2 italic">A path to your best self.</span>
            </h1>
            <p className="mt-6 text-base text-stone-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 leading-relaxed">
          ...
          <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center justify-center">
            <div className="relative mx-auto w-full rounded-2xl shadow-xl lg:max-w-md overflow-hidden group">
               ...
               {isGenerating ? (
                 <div className="w-full h-[500px] bg-stone-200 animate-pulse flex flex-col items-center justify-center text-stone-500">
